...
public class PlayWithRemote {
    ...
    public static void main(String[] args) {
        ...
        // Gets the ElectronicDevice to use POSTAVLJAMO RECIVERA
        ...
        // Postavljamo objekat nad kojim zelimo da izvrsavamo nasu komandu TurnTVOn
        TurnTVOn onCommand = new TurnTVOn(newDevice);

        // Calling the execute() causes on() to execute in Television
        // Ovde je INVOKER DeviceButon postavljamo ovaj invoker da poziva onCommand-u
//        DeviceButton buttonOnPressed = new DeviceButton(onCommand);
        DeviceButton onPressed = new DeviceButton(onCommand);

        // When press() is called theCommand.execute(); executes
//        buttonOnPressed.press();
        onPressed.press();
...
//        DeviceButton ButtonOffPressed = new DeviceButton(offCommand);

        // When press() is called theCommand.execute(); executes
        onPressed.press();
//        ButtonOffPressed.press();
